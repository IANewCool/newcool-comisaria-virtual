...
import { GLOSARIO_LEGAL, LECCIONES_SEGURIDAD, FAQ_COMISARIA, TIPS_SEGURIDAD } from '@/data/comisaria-content';

const GLOSSARY = GLOSARIO_LEGAL;
const LESSONS = LECCIONES_SEGURIDAD;
const FAQ_LIST = FAQ_COMISARIA;
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="text-center py-6">
        ...
        <p className="text-[var(--muted)]">
          Glosario legal, lecciones de prevencion y tips de seguridad para protegerte
        </p>
      </section>
