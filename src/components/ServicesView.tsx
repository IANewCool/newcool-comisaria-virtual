...
import { SERVICIOS_COMISARIA, FAQ_COMISARIA, CANALES_COMISARIA, COMISARIA_INFO } from '@/data/comisaria-content';

const TGR_SERVICES = SERVICIOS_COMISARIA;
const FAQ_LIST = FAQ_COMISARIA;
const CHANNELS = CANALES_COMISARIA;
